...
export default function RippleButton({ children, ...props }: RippleButtonProps) {
  ...
  return (
    <button
      ref={buttonRef}
      className="font-jost duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-red-600 p-[1.3rem] text-[1.2rem] font-medium text-[#fff] transition hover:text-white shadow-md"
      onMouseEnter={(e) => {
